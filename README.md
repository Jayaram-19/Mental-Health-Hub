...
- **Glassmorphism & Aurora UI:** A beautiful, responsive interface featuring ambient gradients and frosted-glass components for a calming user experience.
- **Interactive Tools:**
  - **Ambient Sound Player:** Listen to looping background tracks like rain, ocean waves, or cafe sounds while you focus or relax.
  - **Focus Timer:** A built-in Pomodoro-style timer to manage your work and break sessions.
  - **Guided Breathing (4-4-4):** An animated box breathing exercise to reduce instant stress and anxiety.
- **Daily Affirmation Widget:** Get a random uplifting quote every time you load the dashboard.
- **Confetti Rewards:** Satisfying visual reward elements powered by `canvas-confetti` after finishing focus or breathing sessions.
...
- **Chart.js & React-chartjs-2** for analytics graphing
